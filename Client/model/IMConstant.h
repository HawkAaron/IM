...
static const QString GROUP_NAME_DEFAULT = QStringLiteral("好友");
...
//    FriendInformation(const FriendInformation& fri)
//    {
//        m_headPortrait = fri.m_headPortrait;
//        m_userID = fri.m_userID;
//        m_nickname = fri.m_nickname;
//        m_groupName = fri.m_groupName;
//        m_remarkName = fri.m_remarkName;
//        m_status = fri.m_status;
//    }

//    FriendInformation& operator = (const FriendInformation& fri)
//    {
//        m_headPortrait = fri.m_headPortrait;
//        m_userID = fri.m_userID;
//        m_nickname = fri.m_nickname;
...
//    }
    ...
    // 重载比较运算用于排序
    bool operator < (const FriendInformation& b) const
    {
...
//     QString m_myNickname;
    ...
    ChatInformation()
    {
       ...
       m_headPortrait= 1;
       m_friendMark = QString(QStringLiteral("好友签名"));
    }
