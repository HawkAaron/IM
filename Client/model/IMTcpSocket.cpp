...
//        QMessageBox::critical(NULL, QStringLiteral("系统错误"),
...
void IMTcpSocket::dispalyError(QAbstractSocket::SocketError socketError)
{
    ...
    case QAbstractSocket::RemoteHostClosedError:
        emit showConnectionStatus(QStringLiteral("链接失败.可能是因为服务器关闭."));
        break;
    case QAbstractSocket::HostNotFoundError:
        emit showConnectionStatus(QStringLiteral("链接失败.可能是因为找不到服务器"));
//        QMessageBox::information(NULL, QStringLiteral("IM Client"),
//                                 QStringLiteral("This host was not found.Please check the"
//                                    "host name and port settings."));
        break;
    case QAbstractSocket::ConnectionRefusedError:
        emit showConnectionStatus(QStringLiteral("链接失败.可能是因为连接被拒绝"));
//        QMessageBox::information(NULL, QStringLiteral("IM Client"),
//                                 QStringLiteral("The connection was refused by the peer."
//                                    "Make sure the IM server is running,"
//                                    "and check that the host name and port"
//                                    "settings are correct."));
        break;
    default:
        emit showConnectionStatus(QStringLiteral("链接失败: %1.").arg(errorString()));
//        QMessageBox::information(NULL, QStringLiteral("IM Client"),
//                                 QStringLiteral("The following errot occurred: %1.")
//                                 .arg(errorString()));
    }
}
