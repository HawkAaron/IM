...
void CalendarDialog::initDialog()
{
    ...
    m_monthBox->addItem(QStringLiteral("一月"));//"January");
    m_monthBox->addItem(QStringLiteral("二月"));//"February");
    m_monthBox->addItem(QStringLiteral("三月"));//"March");
    m_monthBox->addItem(QStringLiteral("四月"));//"April");
    m_monthBox->addItem(QStringLiteral("五月"));//"May");
    m_monthBox->addItem(QStringLiteral("六月"));//"June");
    m_monthBox->addItem(QStringLiteral("七月"));//"July");
    m_monthBox->addItem(QStringLiteral("八月"));//"August");
    m_monthBox->addItem(QStringLiteral("九月"));//"September");
    m_monthBox->addItem(QStringLiteral("十月"));//"October");
    m_monthBox->addItem(QStringLiteral("十一月"));//"November");
    m_monthBox->addItem(QStringLiteral("十二月"));//"December");
