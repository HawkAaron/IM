...
void IMDiscussionListWidget::creatMenu()
{
    ...
    QAction *actCreateDiscussion = new QAction(QStringLiteral("新建讨论组"), this);
//    QAction *actAddFlock = new QAction(QStringLiteral("添加讨论组"), this);
    QAction *actRefresh = new QAction(QStringLiteral("刷新讨论组列表"), this);
