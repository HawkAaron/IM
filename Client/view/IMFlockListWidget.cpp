...
void IMFlockListWidget::creatMenu()
{
    ...
    QAction *actCreateFlock = new QAction(QStringLiteral("新建群"), this);
    QAction *actAddFlock = new QAction(QStringLiteral("添加群"), this);
    QAction *actRefresh = new QAction(QStringLiteral("刷新群列表"), this);
