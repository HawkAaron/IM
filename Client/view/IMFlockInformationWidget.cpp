    ...
    QWidget(parent)
{
    ...
    initIMLoginWidget();
    setWindowTitle(QStringLiteral("群信息"));
...
//    m_labelFlockHead->setPixmap(QPixmap(":/images/flock.png"));
    m_labelFlockName = new QLabel(QStringLiteral("群名称:"), this);
    m_labelFlockID = new QLabel(QStringLiteral("群帐号:"), this);
    m_labelTheme = new QLabel(QStringLiteral("群主题:"), this);
