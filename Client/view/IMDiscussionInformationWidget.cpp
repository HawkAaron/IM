    ...
    QWidget(parent)
{
    ...
    initIMLoginWidget();
    setWindowTitle(QStringLiteral("讨论组信息"));
...
//    m_labelDiscussionHead->setPixmap(QPixmap(":/images/discussion.png"));
    m_labelDiscussionName = new QLabel(QStringLiteral("讨论组名称:"), this);
    m_labelDiscussionID = new QLabel(QStringLiteral("讨论组帐号:"), this);
    m_labelTheme = new QLabel(QStringLiteral("讨论组主题:"), this);
    m_labelCreatorID = new QLabel(QStringLiteral("创建者帐号:"), this);
    m_labelCreateDate = new QLabel(QStringLiteral("创建时间:"), this);
    ...
    m_btnCancel = new QPushButton(QStringLiteral("关闭"), this);
